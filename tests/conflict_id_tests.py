import unittest
import numpy as np
from possible_subspace import find_feasible_weight_space, resolve_conflicts, find_conflicts
...
'''
to run: python -m unittest conflict_id_tests.py
note - move this file and assign_preferences to main directory
'''
class TestPreferenceConsistency(unittest.TestCase):
    ...
    def test_size1_inconsistent_preferences(self):
        ...
        conflicts = find_conflicts(pairs, preferences)
